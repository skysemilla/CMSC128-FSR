...
import {Header, Button, Grid, Form, Image,Segment, Message, Divider} from 'semantic-ui-react'
...
export default class Login extends Component {
	...
	render() {
		return(
			...
			<Divider hidden='true'/>
			<Divider hidden='true'/>
				<Grid container columns={2} verticalAlign='middle' style={{height: '70%'}}>
					<Grid.Column>
					</Grid.Column>
					<Grid.Column style={{maxWidth: 450}} floated='center'>
						...
						<Form size='large'>
							<Segment stacked>
								...
								value={this.state.fname} onChange={this.handleChangeUsername} />
								<Header as='h3'> Password </Header>
								<Form.Input fluid icon='lock' iconPosition='left' placeholder='Password' type='password' 
								value={this.state.fname} onChange={this.handleChangePassword} />
								<Button color='blue' fluid size='medium' onClick={this.startLogin} > Login </Button>
							</Segment>
						</Form>

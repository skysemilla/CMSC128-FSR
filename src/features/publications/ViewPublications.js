	...
	render() {
		...
		<div className="App-header">
			...
			<div class="ui compact piled very padded text left aligned container segment" color='teal'>
			  <div>
				  <h2 class="ui blue header">View Publications
			  ...
			  <div>
					<table class="ui celled structured table">
			          ...
			          <tr class="center aligned">
		                  ...
		                  <td>3</td>
		                  <td>3</td>
		                  <td><button class="ui button"><i class="pencil alternate icon"></i></button></td>
		                  <td><button class="ui button"><i class="eye icon"></i></button></td>
			          </tr>
			        {this.state.publications.map((item)=>{
			          return(
			                <tr class="center aligned">
			                  ...
			                  <button class="ui right floated blue button">View Attachments</button>
			                </tr>
			            )
			        })}
			        </table>
			        <button class="ui right floated blue button">Add Publications</button>
			  </div>

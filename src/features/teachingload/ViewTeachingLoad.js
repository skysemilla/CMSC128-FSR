...
//Dummy data 
const dummySample = {seccode : 'CMSC 128', room : 'CAS B04', days : 'T-Th',
                      time : '4pm-7pm', hours:  '3', studnum : '49', creditwo : '3', studcred : '3', creditw : ' 3'};

const dummySample2 = {seccode : 'CMSC 127', room : 'CAS B04', days : 'T-Th',
                      time : '4pm-7pm', hours:  '3', studnum : '49', creditwo : '3', studcred : '3', creditw : ' 3'};

const dummySample3 = {seccode : 'CMSC 129', room : 'CAS B04', days : 'T-Th',
                      time : '4pm-7pm', hours:  '3', studnum : '49', creditwo : '3', studcred : '3', creditw : ' 3'};
        ...
        <div class = "ui piled very padded container segment" color = "teal">
          ...
          <table class = "ui celled table">
            <thead>
              <tr>
                ...
                <th class = "center aligned"> Teaching load credits with Multiplier </th>
            ...
            <tbody>
              {this.state.data.map((item) =>{
                return(
                    <ViewTeachingLoadRow subj = {item.subj} seccode = {item.seccode} room = {item.room} days = {item.days} time = {item.time} hours = {item.hours} studnum = {item.studnum} creditwo = {item.creditwo} studcred = {item.studcred} creditw = {item.creditw} />
                  )
                })
              }
            </tbody>
          ...
          <div>
            ...
            <button class="ui right floated button">
               <a color = "white" href = "./add"> Add to Teaching Load </a>
            </button>
            </h1>
          </div>
          <Divider hidden="true" />

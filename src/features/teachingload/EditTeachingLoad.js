	...
	render() {
		...
		<div className="App-header">
			...
			<div class="ui piled very padded text left aligned container segment" color='teal'>
			  <div>
				  <h2 class="ui blue header">Edit Teaching Load
				  ...
				  <button class="ui right floated blue button">Send to Admin</button>
			  	  ...
			  	  <p>
					  ...
					  <div class="ui input mini focus">
					  		<input type="text" style={{width: "540px"}} value={this.state.subj} onChange={this.handleChangeSubj}/>
					  </div>
				  </p>
			  	  <p>
					  <a class="ui small header"> Section Code   </a>
					  <div class="ui input mini focus">
					  		<input type="text" style={{width: "497px"}} value={this.state.seccode} onChange={this.handleChangeSeccode}/>
					  </div>
				  </p>
				  <p>
					  <a class="ui small header">Room </a>
					  <div class="ui input mini focus">
					  		<input type="text" style={{width: "552px"}} value={this.state.room} onChange={this.handleChangeRoom}/>
					  </div>
				  </p>
				  <p>
					  <a class="ui small header">Days </a>
					  <div class="ui input mini focus">
					  		<input type="text" style={{width: "560px"}} value={this.state.days} onChange={this.handleChangeDays}/>
					  </div>
				  </p>
				  <p>
				  ...
				  <p>
					  ...
					  <div class="ui input mini focus">
					  		<input type="text"  style={{width: "473px"}} value={this.state.hours} onChange={this.handleChangeHours}/>
					  </div>
				  </p>
				  <p>
					  <a class="ui small header">No. of Students </a>
					  <div class="ui input mini focus">
					  		<input type="text"  style={{width: "480px"}} value={this.state.studnum} onChange={this.handleChangeStudnum}/>
					  </div>
				  </p>
				  <p>
					  <a class="ui small header">Course Credit w/o Multiplier </a>
					  <div class="ui input mini focus">
					  		<input type="text"  style={{width: "378px"}} value={this.state.creditwo} onChange={this.handleChangeCreditwo}/>
					  </div>
				  </p>
				  <p>
					  <a class="ui small header">Student Credit Units </a>
					  <div class="ui input mini focus">
					  		<input type="text"  style={{width: "440px"}} value={this.state.studcred} onChange={this.handleChangeStudcred}/>
					  </div>
				  </p>
				  <p>
					  <a class="ui small header">Teaching Load Credits w/ Multiplier </a>
					  <div class="ui input mini focus">
					  		<input type="text"  style={{width: "325px"}} value={this.state.creditw} onChange={this.handleChangeCreditwith}/>
					  </div>
				  </p>
				  <div class="ui center aligned container">
				  	<button class="ui center aligned blue button" onClick={this.startEdit}>Save Teaching Load</button>
				  </div>
			</div>
			 <Divider hidden='true'/>
		</div>
